...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        //Example : Bir String ín bas ve sonunda space characteri varsa siliniz.
        //        "    Ali Can   "  ==>    "Ali Can"
        String s = "   Ali Can   ";
        System.out.println(s);

        //trim methodu bir Stringin bas ve sonundaki space characterlerinji siler, aradaki spacelere dokunmaz.
        String sTrimmed = s.trim();
        System.out.println(sTrimmed);

        //Example 2: Asagida fiyatlari verilen urunlerin toplam fiyatini bulunuz.
        // String tv = "$456.99"; ==> 456.99 + 875.99=1332.98
        ...
        //Example 5: Bir Stringin spce haric hicbir character icermedigini kontrol eden kodu yaziniz.
        ...
        //3. Yol:
        //Note: Sadece space iceren Stringler icin true verir, space disinda bir character icerirse false verir.
        //isBlank() methodu bos Stringler icin de true verir.
        //isBlank() ==> space + hicbirsey icin true        isEmpty==> hicbir sey icin true
        boolean result5 = t.isBlank();
        System.out.println("Sadece space mi var?" + result5);

        //Example 6: Bir YStringde a, i, e karakterlerinin ilk gornumlerinin indexleri toplamini ekrana yazdiriniz
        ...
        //Example 7: Bir Stringde "Java" kelimesinin ilk olarak kacinci indexde kullanildigini gösteren kodu yaziniz.
        ...
        //indexOf() methodu olmayan karakterler icin kullamilirsa her zaman "-1" verir.
        int idxOfXyz = u.indexOf("xyz");
        System.out.println(idxOfXyz); // -1

        //Example 8: Bir Stringde a, i, e karakterlerinin son görünümlerinin indexleri toplamini ekrana yazdiriniz.
        ...
        // Example 9: Bir Stringdeki tekrarsiz characterleri ekrana yazdiriniz.
        //            abbccdc ==> ad
